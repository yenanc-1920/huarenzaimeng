...
onMounted(() => {
  newsList.value = [
    { id: 1, title: '孟加拉签证政策更新通知', cover: '/static/news/placeholder.png', publishTime: '2026-07-25', isTop: true, summary: '最新签证政策变动，请及时了解...' },
    { id: 2, title: '达卡华人超市新开张', cover: '/static/news/placeholder.png', publishTime: '2026-07-24', isTop: false, summary: '位于Gulshan区域的新华人超市...' },
    { id: 3, title: '雨季出行安全提醒', cover: '/static/news/placeholder.png', publishTime: '2026-07-23', isTop: false, summary: '孟加拉进入雨季，请注意出行安全...' }
  ]
})
