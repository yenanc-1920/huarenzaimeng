    ...
    <view class="section">
      ...
      <view class="news-list">
        <view v-for="item in newsList" :key="item.id" class="news-item" @tap="goNewsDetail(item.id)">
          <image class="news-item__cover" :src="item.cover" mode="aspectFill" />
...
function loadMockData() {
  ...
  newsList.value = [
    { id: 1, title: '孟加拉签证政策更新通知', cover: '/static/news/placeholder.png', publishTime: '2026-07-25', isTop: true },
    { id: 2, title: '达卡华人超市新开张', cover: '/static/news/placeholder.png', publishTime: '2026-07-24', isTop: false },
    { id: 3, title: '雨季出行安全提醒', cover: '/static/news/placeholder.png', publishTime: '2026-07-23', isTop: false }
  ]
}
