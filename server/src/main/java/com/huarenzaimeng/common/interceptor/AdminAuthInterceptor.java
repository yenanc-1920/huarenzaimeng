...
import com.huarenzaimeng.module.admin.service.JwtService;
...
public class AdminAuthInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        request.setAttribute("adminId", jwtService.getAdminId(token));
        request.setAttribute("adminUsername", jwtService.getUsername(token));
        return true;
    }
}
